...
func (x *GetCategoryResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *GetCategorysRequest) Reset() {
	*x = GetCategorysRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCategorysRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCategorysRequest) ProtoMessage() {}

func (x *GetCategorysRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_category_category_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCategorysRequest.ProtoReflect.Descriptor instead.
func (*GetCategorysRequest) Descriptor() ([]byte, []int) {
...
var file_proto_category_category_proto_rawDesc = []byte{
	...
	0x5d, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x09, 0x52, 0x0b, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x15,
	0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x32, 0xb1, 0x01, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4c, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x1c, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x73, 0x12, 0x1d, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x11, 0x5a, 0x0f, 0x2f, 0x70, 0x72,
...
var file_proto_category_category_proto_goTypes = []interface{}{
	...
	(*GetCategoryResponse)(nil), // 1: category.GetCategoryResponse
	(*GetCategorysRequest)(nil), // 2: category.GetCategorysRequest
}
var file_proto_category_category_proto_depIdxs = []int32{
	0, // 0: category.CategoryService.GetCategory:input_type -> category.GetCategoryRequest
	2, // 1: category.CategoryService.GetCategorys:input_type -> category.GetCategorysRequest
	1, // 2: category.CategoryService.GetCategory:output_type -> category.GetCategoryResponse
	1, // 3: category.CategoryService.GetCategorys:output_type -> category.GetCategoryResponse
...
func file_proto_category_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_category_category_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCategorysRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CategoryServiceClient interface {
	...
	GetCategorys(ctx context.Context, in *GetCategorysRequest, opts ...grpc.CallOption) (CategoryService_GetCategorysClient, error)
}
...
func (c *categoryServiceClient) GetCategorys(ctx context.Context, in *GetCategorysRequest, opts ...grpc.CallOption) (CategoryService_GetCategorysClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CategoryService_serviceDesc.Streams[0], "/category.CategoryService/GetCategorys", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceGetCategorysClient{stream}
...
type CategoryService_GetCategorysClient interface {
	Recv() (*GetCategoryResponse, error)
	grpc.ClientStream
}

type categoryServiceGetCategorysClient struct {
	grpc.ClientStream
}

func (x *categoryServiceGetCategorysClient) Recv() (*GetCategoryResponse, error) {
...
type CategoryServiceServer interface {
	...
	GetCategorys(*GetCategorysRequest, CategoryService_GetCategorysServer) error
}
...
func (*UnimplementedCategoryServiceServer) GetCategorys(*GetCategorysRequest, CategoryService_GetCategorysServer) error {
	return status.Errorf(codes.Unimplemented, "method GetCategorys not implemented")
}
...
func _CategoryService_GetCategorys_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetCategorysRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CategoryServiceServer).GetCategorys(m, &categoryServiceGetCategorysServer{stream})
}

type CategoryService_GetCategorysServer interface {
	Send(*GetCategoryResponse) error
	grpc.ServerStream
}

type categoryServiceGetCategorysServer struct {
	grpc.ServerStream
}

func (x *categoryServiceGetCategorysServer) Send(m *GetCategoryResponse) error {
...
var _CategoryService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetCategorys",
			Handler:       _CategoryService_GetCategorys_Handler,
			ServerStreams: true,
		},
	},
